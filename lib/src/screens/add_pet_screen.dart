...
class _AddPetScreenState extends State<AddPetScreen> {
  ...
  void initState() {
    ...
    if (widget.isEdit && widget.petData != null) {
      ...
      if (widget.petData!.imagePath != null && widget.petData!.imagePath!.isNotEmpty) {
  ...
  Future<void> _savePetDetails() async {
    ...
    try {
      if (widget.isEdit) {
        await PetService().updatePetToFirebase(petModel);
      } else {
        await PetService().savePetToFirebase(petModel);
      }
